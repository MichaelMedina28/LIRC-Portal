            ...
            <div class="col-4">
                <div class="card">
                    <div class="card-body text-center d-flex flex-column align-items-center">
                        ...
                        <p><?php if (isset($_SESSION['message']) || count($errors) > 0) { echo 'OTP Successfully sent to email! Please Input the code to confirm.'; }?></p>

                        <form action="verifyEmail.php" method="POST" autocomplete="off">
                            <?php
                            if (isset($_SESSION['message'])) {
                            ?>
                                <div class="<?php echo isset($_SESSION['message']) || count($errors) > 0 ? 'error-message' : ''; ?>"><?php echo $_SESSION['message']; ?></div>
                            <?php
                            }
                            ?>
                            ...
                            <div class="mb-3"><input class="form-control" type="number" name="OTPverify" placeholder="One-Time PIN"></div>
                            <div class="mb-3"><button class="btn btn-primary shadow d-block w-100" type="submit" name="verifyEmail" value="Verify">Confirm OTP</button></div>
                        </form>
