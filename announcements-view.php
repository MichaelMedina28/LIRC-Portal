                    ...
                    <div class="container p-3">
                        <div class="card shadow-sm">
                            <div class="card-body px-4 py-3">
                                ...
                                <p class="card-text mb-4"><?php echo $title_date ?></p>
                                ...
                                <div class="row">
                                    <div class="col d-flex justify-content-end p-3"><a class="btn btn-primary" role="button" href="announcements.php">Back</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
