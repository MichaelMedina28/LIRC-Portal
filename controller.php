<?php
    ...
    if (isset($_POST['signup'])) {
        ...
        // count erros
        if (count($errors) === 0) {
            $insertQuery = "INSERT INTO users (firstName,lastName,email,password,gender,code,status)
...
if (isset($_POST['changePassword'])) {
    ...
    if (!empty($passwordErrors)) {
        $errors['password_error'] = implode('<br>', $passwordErrors);
    } else {
